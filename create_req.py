...
print(setting.topo,"生成SFC请求条数：",setting.num_of_sfc)
print("每个交换机计算资源有",str(setting.sw_conpute_range[0])," 单位")
print("每条交换机链路带宽资源有",str(setting.sw_link_bw_range[0])," 单位")
print("每条SFC长度为", '[' + str(setting.sfc_size_range[0]) + ', '+ str(setting.sfc_size_range[1]) + ']')
print("每条SFC带宽资源消耗为", '[' + str(setting.sfc_link_range[0]) + ', '+ str(setting.sfc_link_range[1]) + ']')
print("每条SFC计算资源消耗为", '[' + str(setting.sfc_comp_range[0]) + ', '+ str(setting.sfc_comp_range[1]) + ']')